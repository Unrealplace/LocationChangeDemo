...
-(void)log:(NSDictionary*)info
{
    ...
    [library assetForURL:assetURL
             resultBlock:^(ALAsset *asset)  {
                 ...
                 self.mediaInfo= [NSMutableDictionary dictionaryWithDictionary:imageMetadata];
...
-(void)write
{
    ...
    NSMutableDictionary *metadata = [NSMutableDictionary dictionaryWithDictionary:self.mediaInfo];
    ...
    NSDate *timeDate=[formatter dateFromString:@"2016-11-07 13:14:56"];
    
    
    
    //EXIF数据
    NSMutableDictionary *EXIFDictionary =[[self.mediaInfo objectForKey:(NSString *)kCGImagePropertyExifDictionary]mutableCopy];
   ...
   // NSDate *timeDate=[dateFormatter dateFromString:@"2016-09-09 13:14:56"];
    
   // NSLog(@"%@",EXIFDictionary);
    
    NSMutableDictionary * loginDIc = [self.mediaInfo objectForKey:(NSString*)kCGImagePropertyGPSDictionary];
    NSLog(@"%@",loginDIc);
    
    
    
    NSMutableDictionary * timeDict = [NSMutableDictionary dictionaryWithDictionary:EXIFDictionary];
    
    [timeDict setValue:@"2016-11-07 13:14:56" forKey:@"DateTimeDigitized"];
    
    [timeDict setValue:@"2016-11-07 13:14:56" forKey:@"DateTimeOriginal"];
    ...
    if (metadata&& gpsDict) {
        ...
        [metadata setValue:timeDict forKey:(NSString*)kCGImagePropertyExifDictionary];
